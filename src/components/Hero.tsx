        ...
        <div className="container py-24 lg:py-32">
          ...
          <div className="mt-5 max-w-3xl text-center mx-auto">
            <p className="text-xl text-muted-foreground">
              Searching for a job made effortless✨.
            </p>
      ...
      <div className="container py-24 lg:py-32">
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 items-center gap-6 md:gap-10">
          ...
          <Card>
            ...
            <CardContent>
              Get detailed insights and suggestions to improve your resume.
            </CardContent>
          </Card>
          {/* End Card */}
          {/* Card */}
          <Card>
            <CardHeader className="pb-4 flex-row items-center gap-4">
              ...
              <CardTitle>Summarize JD:</CardTitle>
            </CardHeader>
            <CardContent>
              Understand the key points of job descriptions instantly.
            </CardContent>
          </Card>
          {/* End Card */}
          {/* Card */}
          <Card>
            <CardHeader className="pb-4 flex-row items-center gap-4">
              ...
              <CardTitle>Create Cover Letters:</CardTitle>
            </CardHeader>
            <CardContent>
              Generate tailored cover letters that highlight your strengths.
            </CardContent>
          </Card>
          {/* End Card */}
          {/* Card */}
          <Card>
            ...
            <CardContent>Build professional resumes with ease.</CardContent>
          </Card>
          {/* End Card */}
          {/* Card */}
          <Card>
            ...
            <CardContent>
              Prepare for additional questions that might come up in interviews.
            </CardContent>
          </Card>
          {/* End Card */}
          {/* Card */}
          <Card>
            ...
            <CardContent>
              Customized guides based on your resume and job description.
            </CardContent>
          </Card>
          {/* End Card */}
        </div>
      ...
      <div className="container py-24 lg:py-32">
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 items-center gap-2">
          ...
          >
            ...
            <div className="mt-5">
              <h3 className="text-lg font-semibold">Fine Tuned</h3>
              <p className="mt-1 text-muted-foreground">
                Crafted with the latest design guidelines and best practices
              </p>
              <span className="mt-2 inline-flex items-center gap-x-1.5 text-sm  decoration-2 group-hover:underline font-medium">
                Learn more
                <ChevronRightIcon className="flex-shrink-0 w-4 h-4" />
          ...
          >
            ...
            <div className="mt-5">
              ...
              <p className="mt-1 text-muted-foreground">
                Get advice from industry experts and peers.
              </p>
              <span className="mt-2 inline-flex items-center gap-x-1.5 text-sm  decoration-2 group-hover:underline font-medium">
                Learn more
                <ChevronRightIcon className="flex-shrink-0 w-4 h-4" />
